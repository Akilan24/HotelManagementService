...
public interface UserProxy {
	...
	public ResponseEntity<User> updateUser(@PathVariable("user_id") String userId, @RequestBody @Valid User user);
	...
	public ResponseEntity<User> showUser(@PathVariable("user_id") String userId);

	@GetMapping("/getuserbyname/{username}")
	public User showUserByUserName(@PathVariable("username") String username);

	@GetMapping("/getuserbyemail/{email}")
	public ResponseEntity<User> showUserByEmail(@PathVariable("email") String email);

	@GetMapping("/getuserbymobile/{mobile}")
	public ResponseEntity<User> showUserByMobileNumber(@PathVariable("mobile") String mobile);

	@GetMapping("/deleteuserbyid/{user_id}")
	public ResponseEntity<String> remove(@PathVariable("user_id") String userId);
}
