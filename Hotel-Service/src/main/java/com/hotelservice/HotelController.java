...
public class HotelController {
	...
	public ResponseEntity<?> gethotelbyhotelname(@PathVariable String hotelname) {
		return new ResponseEntity<>(hs.gethotelByHotelName(hotelname), HttpStatus.OK);
	}

	@GetMapping("/gethotelbycityname/{cityname}")
	public ResponseEntity<?> gethotelbycityname(@PathVariable String cityname) {
		return new ResponseEntity<>(hs.gethotelByCity(cityname), HttpStatus.OK);
	}

	@PostMapping("/addhotel")
	public ResponseEntity<?> addhotel(@RequestBody @Valid Hotel htl) throws Exception {
		return new ResponseEntity<>(hs.addhotel(htl), HttpStatus.OK);
	}

	@PutMapping("/updatehotel")
	public ResponseEntity<?> updatehotel(@RequestBody @Valid Hotel ht) {
